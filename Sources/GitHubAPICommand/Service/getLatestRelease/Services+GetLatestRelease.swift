...
extension Services {
    public func getLatestRelease(request: GitHubAPIRequestFactory.GetLatestRelease,
        ...
        do {
            let endpoint = try EndpointFactory.GetLatestRelease(host: host(request: request),
